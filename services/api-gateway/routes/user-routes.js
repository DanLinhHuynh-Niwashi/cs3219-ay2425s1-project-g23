...
userRoutes.post("/users/reset-password/reset", (req, res) => handleHttpCredentialRequest(req, res, base_url, port, "/users/reset-password/reset"));
...
userRoutes.patch("/users/update-password/update", (req, res) => handleHttpCredentialRequest(req, res, base_url, port, "/users/update-password/update"));
